...
func main() {
	...
	issuerId := "3388000000022241664"
	// classSuffix := strings.ReplaceAll(uuid.New().String(), "-", "_")
	classSuffix := "de2bb511_02f2_4b63_8b40_07bb377a6b8e"
	fmt.Printf("classSuffix: %v\n", classSuffix)
	// 292dfcf7_a10b_4f1b_8cd9_019b5fb6f05f-de2bb511_02f2_4b63_8b40_07bb377a6b8e
	objectSuffix := fmt.Sprintf("%s-%s", strings.ReplaceAll(uuid.New().String(), "-", "_"), classSuffix)
	objectSuffix = "292dfcf7_a10b_4f1b_8cd9_019b5fb6f05f-de2bb511_02f2_4b63_8b40_07bb377a6b8e"
	fmt.Printf("objectSuffix: %v\n", objectSuffix)

	d := demoEventticket{}

	d.auth()
	res, err := d.httpClient.Get(fmt.Sprintf("https://walletobjects.googleapis.com/walletobjects/v1/eventTicketObject/%s.%s", issuerId, objectSuffix))
	if err != nil {
		fmt.Println(err)
	} else {
		b, _ := io.ReadAll(res.Body)
